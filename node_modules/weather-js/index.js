...
module.exports = (function() {
  ...
  var find = function find(options, callback) {
    ...
    if(!options || typeof options !== 'object')
      return callback('**🚫 |** cài đặt không hợp lệ');

    if(!options.search)
      return callback('**🚫 |** Xin hãy ghi vị trí');
    ...
    request.get({url: reqUrl, timeout: timeout}, function(err, res, body) {
      ...
      if(!body)                  return callback(new Error('tìm nội dung thất bại'));
      ...
      if(body.indexOf('<') !== 0) {
        ...
        return callback(new Error('**🚫 |** nội dung không hợp lệ'));
      }
      ...
      xmlParser.parseString(body, function(err, resultJSON) {
        ...
        if(!resultJSON || !resultJSON.weatherdata || !resultJSON.weatherdata.weather)
          return callback(new Error('**🚫 |** không thể in data thời tiết'));
        ...
        if(!(resultJSON.weatherdata.weather instanceof Array)) {
          return callback(new Error('**🚫 |** thiếu thông tin thời tiết'));
        }
